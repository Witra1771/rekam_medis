                                ...
                                <td class="btn-group">
                                    @if ($d->Status == 'Menunggu')
                                        <button  type="button" class="btn btn-primary btn-sm mr-2" data-toggle="modal"
                                            data-target="#modal-ubah-{{ $d->id_antrean }}">
                                            Tambah Pendaftar
                                        </button>
                                        <a href="{{url('/antrean/'.$d->id_antrean.'/cetak')}}" class="btn btn-success btn-sm">
                                            Cetak No Antrean
                                        </a>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="umur" id="umur" placeholder="0"
                                            style="max-width:10%;">
                                        <div class="input-group-prepend">
