                            ...
                            <tr>
                                ...
                                <td class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#modal-hapus-{{ $d->id_pasien }}">
                                        Hapus
                                    </button>
                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-daftar-{{ $d->id_pasien }}">
                                        Daftar
                                    </button>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Body   -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{ url('/pendaftaran/tambah') }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="nik" id="" maxlength="16">
                                        </div>
                                    </div>
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" required name="nama_pasien" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <select name="status_pekerjaan" required id="" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <select name="pola_pekerjaan" required id="" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" required name="keterampilan_teknis" id=""
                                                        class="form-control" placeholder="lihat petunjuk pengisian">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <div class="input-group input-group-sm">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Pendidikan
                                                            Terakhir</span>
                                                    </div>
                                                    <select name="pendidikan_terakhir" required id="" class="form-control">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" required name="tempat_lahir" id="tem"
                                                style="max-width:30%;" placeholder="Tempat">
                                            <input type="date" class="form-control" required name="tanggal_lahir"
                                                id="tanggal_lahir" onchange="umur_pasien()">
                                            <input type="text" class="form-control" readonly name="umur" id="umur"
                                                placeholder="0" style="max-width:10%;">
                                            <div class="input-group-prepend">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="custom-select" required name="jk" id="">
                                    ...
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" required name="pekerjaan" id=""
                                                placeholder="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="custom-select" required name="status_perkawinan" id="">
                                    ...
                                    <div class="form-group col-md-5">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" maxlength="13" required name="nohp" id="" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" required class="custom-file-input" name="foto_ktp"
                                                    id="inputGroupFile01">
                                        ...
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" required class="custom-file-input" name="foto_pasien"
                                                    id="inputGroupFile01">
                                                <label class="custom-file-label" for="inputGroupFile01">Choose
                                                    file</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="custom-select" required name="spesialis" id="">
                                                <option value="">--Pemeriksaan--</option>
                                                @foreach ($spesialis as $d)
                                                    <option value="{{ $d->kode_spesialis }}">
                                                        {{ $d->spesialis_kedokteran }}</option>
                                                @endforeach
                                            </select>
                                            <select class="custom-select" required name="nama_dokter" id="">
                                                <option disabled>--Dokter--</option>
                                                @foreach ($user as $d)
                                            ...
                                            <input type="text" class="form-control" id="" style="max-width: 10%;"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form" name="edit" method="post"
                            action="{{ url('/pendaftaran/ubah', $d->id_pasien) }}" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="nama_pasien" id=""
                                                placeholder="" value="{{ $d->nama_pasien }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="tempat_lahir" id="tem"
                                                placeholder="Tempat" value="{{ $d->tempat_lahir }}">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="custom-select" name="jk" id="">
                                                ...
                                                <option value="Laki-laki" <?php if ($d->jk == 'Laki-laki') {
    echo 'selected';
} ?>>Laki-laki</option>
                                                <option value="Perempuan" <?php if ($d->jk == 'Perempuan') {
    echo 'selected';
} ?>>Perempuan</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" class="form-control" name="pekerjaan" id=""
                                                placeholder="" value="{{ $d->pekerjaan }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <textarea class="form-control" name="alamat"
                                                aria-label="With textarea">{{ $d->alamat }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-7">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <select class="custom-select" name="status_perkawinan" id="">
                                                <option value="Belum Menikah" <?php if ($d->status_perkawinan == 'Belum Menikah') {
    echo 'selected';
} ?>>Belum Menikah</option>
                                                <option value="Menikah" <?php if ($d->status_perkawinan == 'Menikah') {
    echo 'selected';
} ?>>Menikah</option>
                                                <option value="Cerai Hidup" <?php if ($d->status_perkawinan == 'Cerai Hidup') {
    echo 'selected';
} ?>>Cerai Hidup</option>
                                                <option value="Cerai MAti" <?php if ($d->status_perkawinan == 'Cerai Mati') {
    echo 'selected';
} ?>>Cerai Mati</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group input-group-sm mb-3">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="foto_ktp"
                                                    id="fotoKtp" value="{{ $d->foto_ktp }}">
                                                <label class="custom-file-label" for="inputGroupFile01">Pilih
                                                    Image</label>
                                            </div>
                                        </div>
                                        <input type="text" name="foto_ktp" class="form-control"
                                            value="{{ $d->foto_ktp }}" hidden>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-group input-group-sm mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" name="foto_pasien"
                                                    id="inputGroupFile01" value="{{ $d->foto_pasien }}">
                                                <label class="custom-file-label" for="inputGroupFile01">Pilih</label>
                                            </div>
                                        </div>
                                        <input type="text" name="foto_pasien" class="form-control"
                                            value="{{ $d->foto_pasien }}" hidden>
                                    </div>
                                </div>
                            </div>
                            <!-- /.card-body -->
            ...
            <div class="modal-dialog modal-lg" style="width:600px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- form start -->
                        <form role="form" name="edit" method="post"
                            action="{{ url('/pendaftaran/daftar', $d->id_pasien) }}" enctype="multipart/form-data">
                            @csrf
