...
<div class="container-fluid">
  ...
  <div class="card">
    ...
    @foreach ($Fantrean as $d)
      <form role="form" name="edit" method="post" action="{{ url('/pemeriksaan/tambahJiwa') }}" enctype="multipart/form-data">
        @csrf      
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-5" hidden>    
                <div class="input-group input-group-sm" >
                  ...
                  <input type="text" class="form-control" name="id_antrean" id="" value="{{ $d->id_antrean }}" >
                    <input type="text" class="form-control" name="id_pasien" id="" value="{{ $d->pasien }}" >
                    <input type="text" class="form-control" name="nik" id="" value="{{ $d->nik }}" readonly ><br>
                        ...
                        <div class="row">
                          <div class="form-group col-md-12">
                            <div class="input-group input-group-sm">
                              ...
                              <input type="text" class="form-control" name="T" id="jk" placeholder="">
                              <div class="input-group-prepend">
                                <span class="input-group-text">N</span>
                              </div>
                              <input type="text" class="form-control" name="N" id="jk" placeholder="">
                              <div class="input-group-prepend">
                                <span class="input-group-text">RR</span>
                              </div>
                              <input type="text" class="form-control" name="RR" id="jk" placeholder="">
                              <div class="input-group-prepend">
                                <span class="input-group-text">SB</span>
                              </div>
                                <input type="text" class="form-control" name="SB" id="jk" placeholder="">
                              </div>
                            </div> 
                          </div>
                          <div class="row">
                            <div class="form-group col-md-4">
                              <div class="input-group input-group-sm">
                                  ...
                                  <select name="penampilan" id="" class="form-control">
                              ...
                              <div class="form-group col-md-4">
                                <div class="input-group input-group-sm">
                                  ...
                                  <select name="cara_berjalan" id="" class="form-control">
                              ...
                              <div class="form-group col-md-4">
                                <div class="input-group input-group-sm">
                                  ...
                                  <select name="cara_bicara" id="" class="form-control">
                            ...
                            <div class="row">
                              <div class="form-group col-md-4">
                                <div class="input-group input-group-sm">
                                  ...
                                  <select name="konjungtiva" id="" class="form-control">
                              ...
                              <div class="form-group col-md-4">
                                <div class="input-group input-group-sm">
                                  ...
                                  <select name="bekas_suntikan" id="" class="form-control">
                              ...
                              <div class="form-group col-md-4">
                                <div class="input-group input-group-sm">
                                    ...
                                    <select name="tremor" id="" class="form-control">
                                      <option value="Ada">Ada</option>
                                      <option value="Tidak Ada">Tidak Ada</option>
                                    </select>
                                  </div>
                              ...
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <select name="alur_pembicaraan" id="" class="form-control">
                              ...
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <select name="waham" id="" class="form-control">
                              ...
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <select name="halusinasi" id="" class="form-control">
                                      <option value="A">Ada</option>
                                      <option value="Ta">Tidak Ada</option>
                                    </select>
                                  </div>
                              ...
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <textarea name="akustik" id="" class="form-control" cols="40" rows="3"></textarea>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <textarea name="visual" id="" class="form-control" cols="40" rows="3"></textarea>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <textarea name="psik_lain" id="" class="form-control" cols="20" rows="3"></textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div class="form-group col-md-4">
                                    <div class="input-group input-group-sm">
                                            <div class="custom-control custom-checkbox">
                                              ...
                                              name="benzodiazepine" value="Benzodiazepine">
                                              <label for="customCheckbox1" class="custom-control-label">Benzodiazepine</label>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="form-group col-md-4">
                                        <div class="custom-control custom-checkbox">
                                          ...
                                          <label for="customCheckbox2" class="custom-control-label">Cocaine</label>
                                        </div>
                                      </div>
                                      <div class="form-group col-md-4">
                                        <div class="custom-control custom-checkbox">
                                          <input class="custom-control-input" type="checkbox" id="customCheckbox3"
                                          name="amphetamin" value="Amphetamin">
                                          <label for="customCheckbox3" class="custom-control-label">Amphetamin</label>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row form-group">
                                      <div class="form-group col-md-4">
                                        <div class="input-group input-group-sm">
                                          <div class="custom-control custom-checkbox">
                                            ...
                                            name="cthc_marijuana" value="CTHC/Marijuana">
                                            <label for="customCheckbox4" class="custom-control-label">CTHC/Marijuana</label>
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group col-md-4">
                                          <div class="custom-control custom-checkbox">
                                            ...
                                            name="methaphetamine" value="Methaphetamine">
                                            <label for="customCheckbox5" class="custom-control-label">Methaphetamine</label>
                                          </div>
                                        </div>
                                        <div class="form-group col-md-4">
                                          <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="customCheckbox6"
                                            name="morphin" value="Morphin">
                                            <label for="customCheckbox6" class="custom-control-label">Morphin</label>
                                          </div>
                                        </div>
                                    </div>                             
                                  </div>
                              ...
                              <div class="card form-group">
                                    ...
                                    <div class="form-group col-md-12">
                                      <div class="input-group input-group-sm">
                                        ...
                                        <select name="alur_pembicaraan" id="" class="form-control">
                                          ...
                                          <option value="0"<?php if ($d->status_perkawinan == '0') {echo "Selected";}?>>Belum Menikah</option>
                                          <option value="1"<?php if ($d->status_perkawinan == '1') {echo "Selected";}?>>Menikah</option>
                                          <option value="2"<?php if ($d->status_perkawinan == '2') {echo "Selected";}?>>Duda/Janda</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group col-md-12">
                                  <div class="input-group input-group-sm">
                                    ...
                                    <select name="waham" id="" class="form-control">
                                      <option value="0">Tidak Sekolah/Tidak Tamat</option>
                                      <option value="1">Tamat SD</option>
                                      <option value="2">Tamat SLTP</option>
                                      <option value="3">Tamat SLTA</option>
                                      <option value="4">Tamat Akademi</option>
                                      <option value="5">Tamat PT</option>
                                    </select>
                                  </div>
                                </div>
                              </div>
...
<!-- rapihkan -->
    ...
    ?> 
                        ...
                        <div class="card-header">Status Medis</div>
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-6">
                                <div class="card">
                                  <div class="card-header">Riwayat Rawat Inap yang tidak terkait masalah narkotika</div>
                                  <div class="card-body">                                  
                                    <div class="row">
                                      <p id="contoh2"></p>
                                      <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm">
                                          <div class="input-group-prepend">
                                            <span class="input-group-text">Jenis Penyakit</span>
                                          </div>
                                          <input type="text" class="form-control" name="sm_jenis_penyakit{{$id_antrean}}[]" id="sm_jenis_penyakit{{$id_antrean}}">
                                        </div>
                                      </div>
                                      <div class="form-group col-md-12">
                                        <div class="input-group input-group-sm">
                                          ...
                                          <input type="date" class="form-control" name="dari{{$id_antrean}}[]" id="dari" onchange="tahun_rawat_inap()">
                                          <input type="date" class="form-control" name="sampai{{$id_antrean}}[]" id="sampai" onchange="tahun_rawat_inap()">
                                          <input type="text" class="form-control" id="tahun_rawatInap" style="max-width:10%;" readonly>
                                          <div class="input-group-prepend">
                                    ...
                                    <div class="card_footer">
                                      <input type="button"  class="btn btn-primary btn-sm float-right" name="pekerjaan" id="" onclick="rawat_inap({{$id_antrean}})" value="tambah">
                                    </div><br><br>
                            ...
                            <div class="col-md-6">  
                              <div class="form-group">
                                <div class="col-md-12">
                                  <div class="input-group input-group-sm">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text">Riwayat Penyakit Kronis</span>
                                    </div>
                                      <select name="penyakit_kronis" id="" class="form-control">
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      ...
                                      <textarea name="jenis_penyakit_kronis" id="" cols="20" rows="3" class="form-control" placeholder="Isi jika memiliki riwayat penyakit kronis"></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Terapi Medis</span>
                                      </div>
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      ...
                                      <textarea name="jenis_terapi" id="" cols="20" rows="3" class="form-control" placeholder="Isi jika sedang menjalani terapi medis"></textarea>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card-body">
                                      <div class="row form-gruop">
                                        <div class="input-group input-group-sm">
                                          ...
                                          <select name="hiv" id="" class="form-control">
                                            <option value="">Pernah Menjalani Test</option>
                                            <option value="">Tidak pernah menjalani test</option>
                                          </select>
                                        </div>
                                      </div>
                                      <div class="row form-gruop">
                                        <div class="input-group input-group-sm">
                                          ...
                                          <select name="hepatitib" id="" class="form-control">
                                            <option value="">Pernah Menjalani Test</option>
                                            <option value="">Tidak pernah menjalani test</option>
                                          </select>
                                        </div>
                                      ...
                                      <div class="row form-gruop">
                                        <div class="input-group input-group-sm">
                                          ...
                                          <div class="input-group-prepend">
                                            <span class="input-group-text">Hepatitis C</span>
                                          </div>
                                         <select name="hepatitisc" id="" class="form-control">
                                            <option value="">Pernah Menjalani Test</option>
                                            <option value="">Tidak pernah menjalani test</option>
                                          </select>
                                        </div>
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <div class="col-md-12">
                                      <div class="input-group input-group-sm">
                                        <div class="input-group-prepend">
                                          <span class="input-group-text">Status Pekerjaan</span>
                                        </div>
                                        <select name="status_pekerjaan" id="" class="form-control">
                                ...
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Pola Pekerjaan</span>
                                      </div>
                                      <select name="pola_pekerjaan" id="" class="form-control">
                                        <option value="0">Penuh Waktu</option>
                                        <option value="1">Paruh Waktu</option>
                                        <option value="2">Tidak Tentu</option>
                                      </select>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Kode Pekerjaan</span>
                                      </div>
                                      <input type="text" name="kode_pekerjaan" id="" class="form-control" placeholder="lihat petunjuk pengisian">
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group">
                                  <div class="col-md-12">
                                    <div class="input-group input-group-sm">
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Keterampilan Teknis</span>
                                      </div>
                                      <input type="text" name="keterampilan_teknis" id="" class="form-control" placeholder="lihat petunjuk pengisian">
                                    </div>
                                  </div>
                                </div>
                                      ...
                                      <div class="col-md-6"> 
                                        <div class="form-group">
                                          <div class="col-md-12">
                                            <div class="input-group input-group-sm">
                                              <div class="input-group-prepend">
                                                <span class="input-group-text">Adakah yang Memeberi Dukungan Hidup?</span>
                                              </div>
                                              <input type="text" name="dukungan_hidup" id="" class="form-control" placeholder="lihat petunjuk pengisian">
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <div class="col-md-12">
                                            <div class="input-group input-group-sm">
                                              ...
                                              <input type="text" name="pemberi_dukungan" id="" class="form-control" placeholder="lihat petunjuk pengisian">
                                            </div>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                  <div class="col-md-12">
                                    ...
                                    <div class="input-group input-group-sm">
                                      ...
                                      <select name="finansial" id="" class="form-control">
                                        <option value="0">Tidak</option>
                                        <option value="1">Ya</option>
                                      </select>
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Tempat Tinggal</span>
                                      </div>
                                    ...
                                    <div class="input-group input-group-sm">
                                      ...
                                      <select name="makan" id="" class="form-control">
                                        <option value="0">Tidak</option>
                                        <option value="1">Ya</option>
                                      </select>
                                      <div class="input-group-prepend">
                                        <span class="input-group-text">Pengobatan/Perawatan</span>
                                      </div>
                                      <select name="pngbtn_prwtn" id="" class="form-control">
                                        <option value="0">Tidak</option>
                                        <option value="1">Ya</option>
                                      </select>
                                    </div>
                        ...
                        <div class="row card-body">
                            ...
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-sm">
                                  ...
                                  <span class="input-group-text">2. Nasal/Sublingal/Suppositoria</span>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">Pernah Menjalani terapi Rehabilitas?</span>
                                </div>
                            ...
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                ...
                                <input type="text" name="SPN_jenis_terapi" id="" class="form-control" placeholder="Isi Jika Pernah Menjalani terapi">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">Pernah Mengalami Overdosis?</span>
                                </div>
                            ...
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                  <span class="input-group-text">Kapan Waktu <br> Overdosis</span>
                                </div>
                                <textarea name="waktu_overdosis" id="" cols="20" rows="2" class="form-control" placeholder="Isi Jika Pernah Mengalami Overdosis"></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                  ...
                                  <select name="cara_penanggulangan" id="" class="form-control">
                                    <option value="0">Perawatan Di RS</option>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <table class="table table-striped table-hover col-md-6">
                              ...
                              <tbody>
                                  <td><input type="text" name="zat_lain_isi" id="" class="form-control" placeholder="Isi jika menggunakan zat lain"></td>
                                  <td>
                ...
                <div class="row form-group">
                  <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">Status Legal | Berapa kalikah dalam hidup anda ditangkap dan dituntut dengan hal berikut : (pilih 1 untuk Ya, pilih 2 untuk Tidak)</div>
                        <div class="card-body">
                          <div class="form-group">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="SL_lain_isi">
                                    </div>
                                  </td>
                                  <td>
                        ...
                        <div class="row card-body">
                          <div class="col-md-6">
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                ...
                                <select name="kondisi_hidup" id="" class="form-control">
                                  <option value="1">Pasangan dan Anak</option>
                            ...
                            <div class="form-group">
                              <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Hidup dengan seseorang dengan penyalahgunaan zat?</span>
                                </div>
                              ...
                              <div class="row card-body">
                                <div class="col-md-8">
                                  <div class="form-group">
                                    <div class="input-group input-group-sm">
                                      <div class="input-group-prepend">
                                          <span class="input-group-text">Saudara Kandung/Tiri</span>
                                      </div>
                                      <select name="saudara_kandung_tiri" id="" class="form-control">
                                        <option value="0">Tidak</option>
                                        <option value="1">Ya</option>
                                      </select>
                                    </div>
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <div class="input-group input-group-sm">
                                      ...
                                      <input type="text" name="RL_lainnya_isi" id="" class="form-control">
                                      <select name="RL_lainnya" id="" class="form-control" style="max-width:30%;">
                                        <option value="0">Tidak</option>
                                        <option value="1">Ya</option>
                                      </select>
                                    </div>
                              ...
                              <div class="card-body">
                                <table class="table table-sm table-striped table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>Keluarga lain
                                        <input type="text" name="Klain_isi" id="" class="form-control" placeholder="Isi jika ada">
                                      </td>
                                    ...
                                    <tr>
                                      <td>Teman Akrab</td>
                                      <td><input type="radio" name="TmnAkrab" id="" value="1">1</td>
                                      <td><input type="radio" name="TmnAkrab" id="" value="2">2</td>
                                    </tr>
                                    <tr>
                                      <td>Tetangga</td>
                                      <td><input type="radio" name="ttg" id="" value="1">1</td>
                                      <td><input type="radio" name="ttg" id="" value="2">2</td>
                                    </tr>
                                    <tr>
                                      <td>Teman Kerja</td>
                                      <td><input type="radio" name="TmnKerja" id="" value="1">1</td>
                                      <td><input type="radio" name="TmnKerja" id="" value="2">2</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                  ...
                  <div class="row form-group">  
                    <div class="col-md-12">
                      <div class="card">
                        <div class="card-header">
                          Status Psikiatris | Apakah pernah mengalami hal-hal berikut ini (yang bukan akibat langsung dari pengguna napza)
                        </div>
                        <div class="card-body">
                          <table class="table table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td>Mengalami halusinasi kesulitan (melihat / mendengar sesuatu yang tidak ada objeknya)</td>
                              ...
                              <tr>
                                <td>mengalami kesukaran mengontrol perilaku kasar, termasuk kemarahan atau kekerasan</td>
      ...
      <div class="input-group input-group-sm">
        <div class="input-group-prepend">
         ...
         <select class="form-control" name="obat[]" id="obat{{$id_antrean}}" style="max-width:30%;">
          @foreach($obat as $d)
            <option value="{{ $d->id_obat }}">{{ $d->nama_obat." ".$d->dosis}}</option>
          @endforeach
        </select>
        <input type="text" class="form-control" name="aturan_pakai[]" id="aturan_pakai{{$id_antrean}}" placeholder="Aturan Pakai">
        <input type="text" class="form-control" name="jumlah[]" id="jumlah{{$id_antrean}}" placeholder="" style="max-width:10%;">
                                
        <div class="input-group-prepend">
          <input type="button"  class="btn btn-primary btn-sm" name="pekerjaan" id="" onclick="myFunction({{$id_antrean}})" value="+">
        </div>
      </div><br>
      <table id="Table" class="table">
        <thead>
